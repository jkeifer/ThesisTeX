...
\setlength{\textfloatsep}{28pt plus 4.0pt minus 2.0pt}  % change space between text and floats

\setlength{\floatsep}{24pt plus 12.0pt minus 6.0pt}  % change space between floats
...
\usepackage{xspace}
\usepackage{url}
\urlstyle{same}  % set the url font
\usepackage{makeidx}
