...
\usepackage[justification=centering, labelfont=bf, compatibility=true, singlelinecheck=on]{caption} %caption package with centering, and can be 10pts, per thesis guidelines (REMOVED small command)
