...
The classification process is complex; \autoref{appendix:tools:classify} contains a full discussion of the process, so I will refrain from a lengthy description here.
