\chapter{Reflecting on My Field Work}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/pig.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/digging1.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/digging2.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/badroad.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/clearing.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/sorghum.png}
...
%\begin{ssfigure}
%  \centering
%  \includegraphics[width=0.5\textwidth]{Graphics/Pics/cows.png}
%  \caption{Up Close and Personal with the Cows at \textit{Estancia La Armonia}}
%  \label{pic:cows}
%\end{ssfigure}

\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/soy.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/flood.png}
...
\begin{ssfigure}
  \centering
  \includegraphics[width=1.0\textwidth]{Graphics/Pics/corn.png}
