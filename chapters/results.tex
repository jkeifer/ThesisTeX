...
\begin{ssfigure}
  ...
  \medskip
  \small
  Comparing this map to the ground truth in \cref{map:pellegrini:groundtruth} on \autopageref{map:pellegrini:groundtruth}, one can see how well the classification was able to separate soy and corn fields from the other classes. However, these fields are overwhelmingly classified as corn, suggesting major class confusion between the two. 
