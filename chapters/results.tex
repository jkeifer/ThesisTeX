...
\begin{sstable}
  ...
  \begin{tabu}{X[0.45,m,c]X[1,m,c]X[.95,m,c]X[0.5,m,c]}
    ...
    \midrule
    Soy & \noyear\formatdate{15}{12}{1} to \noyear\formatdate{15}{1}{1} & End of February & \noyear\formatdate{1}{5}{1} \\
    Corn & \noyear\formatdate{15}{1}{1} to \noyear\formatdate{15}{2}{1} & End of February & \noyear\formatdate{1}{6}{1} \\
    Sorghum & \noyear\formatdate{15}{1}{1} to \noyear\formatdate{15}{2}{1} & End of February & \noyear\formatdate{1}{6}{1} \\
    Poroto & \noyear\formatdate{15}{1}{1} to \noyear\formatdate{20}{2}{1} & Early March & \noyear\formatdate{10}{5}{1} \\
    \bottomrule
  \end{tabu}
\end{sstable}
