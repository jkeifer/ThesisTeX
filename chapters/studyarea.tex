...
\begin{sstable}
  ...
  \begin{tabu} to 4.5in {X[1,m,c]X[2,m,c]}
    ...
    \midrule
    Wheat & \noyear\formatdate{25}{9}{1} to \noyear\formatdate{20}{10}{1} \\
    Triticale & \noyear\formatdate{1}{9}{1} to \noyear\formatdate{25}{9}{1} \\
    Winter Barley & \noyear\formatdate{15}{9}{1} to \noyear\formatdate{10}{10}{1} \\
    Spring Barley & \noyear\formatdate{25}{2}{1} to \noyear\formatdate{15}{3}{1} \\
    Spring Wheat & \noyear\formatdate{25}{2}{1} to \noyear\formatdate{15}{3}{1}\\
    Spring Oats & \noyear\formatdate{25}{2}{1} to \noyear\formatdate{15}{3}{1}\\
    Corn & \noyear\formatdate{1}{4}{1} to \noyear\formatdate{10}{5}{1} \\
    Sorghum & \noyear\formatdate{15}{5}{1} to \noyear\formatdate{20}{6}{1} \\
    Soybeans & \noyear\formatdate{5}{5}{1} to \noyear\formatdate{10}{6}{1} \\
    \bottomrule
  \end{tabu}
\end{sstable}
